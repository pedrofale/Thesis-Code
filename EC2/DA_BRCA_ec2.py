...
# Load the data
patterns = np.load('/home/ubuntu/data/brca-patterns.npy')
labels = np.load('/home/ubuntu/data/brca-labels.npy')
...
for train_index, test_index in fold_splits:
    np.save('/home/ubuntu/temp_data/x_train_' + str(j), normalized_data[train_index])
    np.save('/home/ubuntu/temp_data/y_train_' + str(j), labels[train_index])
...
for i in range(k):
    ...
    x_train = np.load('/home/ubuntu/temp_data/x_train_' + str(i) + '.npy')
    y_train = np.load('/home/ubuntu/temp_data/y_train_' + str(i) + '.npy')
    ...
    np.save('/home/ubuntu/temp_data/x_train_sm.npy', x_train_sm)
    del x_train_sm
    ...
    x_train_sm = np.load('/home/ubuntu/temp_data/x_train_sm.npy', mmap_mode='r')
...
print("PCA accuracy: %0.5f (+/- %0.5f)" % (scores_pca.mean(), scores_pca.std() * 2))
print("DA accuracy: %0.5f (+/- %0.5f)" % (scores_da.mean(), scores_da.std() * 2))